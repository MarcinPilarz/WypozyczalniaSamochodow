...
public class UwierzytelnienieController {
	 ...
	 *
	 * @param user Obiekt użytkownika zawierający dane logowania.
	 * @return ResponseEntity z zalogowanym użytkownikiem i statusem HTTP 200 OK lub
	 *         błędem uwierzytelniania z statusem HTTP 401 Unauthorized.
	 */
	@PostMapping("/login")
	 ...
	 *
	 * @return ResponseEntity z zalogowanym użytkownikiem i statusem HTTP 200 OK lub
	 *         pustym obiektem User i statusem HTTP 401 Unauthorized.
	 */
	@GetMapping("/login")
